/* ============================================================
   Location St-Flo — v5 (bento immersif / aurora)
   ============================================================ */
(function () {
  "use strict";
  ...
  /* Season toggle with sliding pill */
  const tog = document.querySelector(".seasontog");
  if (tog) {
    ...
    const set = (s) => {
      ...
      tog.classList.toggle("is-high", s === "high");
      document.querySelectorAll(".ptable b[data-season]").forEach((el) => {
